...
module Regularity.Automata.NFAI
  ( NFA()
  , shiftBy
  )
where
...
instance Automaton NFA where
  accepts = Regularity.Automata.NFAI.accepts

  empty = Regularity.Automata.NFAI.empty
  epsilon = Regularity.Automata.NFAI.epsilon
  char = Regularity.Automata.NFAI.char
  seq = Regularity.Automata.NFAI.seq
  alt = Regularity.Automata.NFAI.alt
  star = Regularity.Automata.NFAI.star
