...
module Regularity.Automata.NFAeI
  ( NFAe()
  , shiftBy
  )
where
...
instance Automaton NFAe where
  accepts = Regularity.Automata.NFAeI.accepts

  empty = Regularity.Automata.NFAeI.empty
  epsilon = Regularity.Automata.NFAeI.epsilon
  char = Regularity.Automata.NFAeI.char
  seq = Regularity.Automata.NFAeI.seq
  alt = Regularity.Automata.NFAeI.alt
  star = Regularity.Automata.NFAeI.star
